...
public class C04_WebTables extends TestBase {
    ...
    public void webTabletesti(){
        ...
        List<String> satirListesiStr = ReusableMethods.stringListOlustur(satirElementleriListesi);
        ...
        List<String> baslikListesiStr = ReusableMethods.stringListOlustur(baslikElementleriList);
